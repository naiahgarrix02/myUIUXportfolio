    ...
    <a className='cursor-pointer'>
        <div className='font-[Satoshi] divide- divide-white '>
            {projectLinks.map((item) => (
                <div
                    key={item.number}
                    className='relative group flex items-center justify-between py-3 border-t border-white hover:bg-white px-4 hover:text-black'
                >
                    ...
                    <img 
                        ...
                        <div className='absolute top-[20px] right-20 opacity-0 scale-75 translate-y-5 
