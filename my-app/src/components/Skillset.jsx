...
const Skillset = () => {
  return (
    <div className='ml-[60px] mr-[60px] mt-[60px] mb-[109px] flex flex-col justify-between'>
        <h1 className='text-[40px] font-regular mt-[36px] greyish'>skillset & tools.</h1>

        <div className='flex flex-row justify-between'>
            <h1 className='text-[200px] font-[Satoshi] font-regular leading-[170px] mt-[36px] tracking-[-15px]'>ui/ux <span className='greyish'>branding</span>
